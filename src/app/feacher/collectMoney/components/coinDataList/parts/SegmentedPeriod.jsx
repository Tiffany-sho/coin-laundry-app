...
export function PeriodFilterButton() {
  ...
  const appliedEndVal = endEpoch === null ? MAX_MONTHS : epochToSliderVal(endEpoch);
              ...
              <VStack gap={4} align="stretch">
                ...
                <HStack justify="center" gap={1} align="flex-end">
                  <VStack gap={0} align="flex-start">
                    <Text fontSize="2xs" color="var(--text-muted)">開始日</Text>
                    <Text fontSize="sm" fontWeight="semibold">{draftStartStr}</Text>
                  </VStack>
                  <Text color="var(--text-muted)" pb="1px" lineHeight="1">〜</Text>
                  <VStack gap={0} align="flex-start">
                    <Text fontSize="2xs" color="var(--text-muted)">終了日</Text>
                    <Text fontSize="sm" fontWeight="semibold">{draftEndStr}</Text>
                  </VStack>
                </HStack>
                ...
                >
                  <HStack justify="space-between" mb={1}>
                    <Text fontSize="2xs" color="var(--text-muted)">5年前</Text>
                    <Text fontSize="2xs" color="var(--text-muted)">今月</Text>
                  </HStack>
                  <Slider.Control>
                    <Slider.Track>
                      <Slider.Range />
                      ...
                      <HStack justify="space-between">
                        ...
                        {!allDraftSelected && (
                          <Text
                            ...
                            color="cyan.600"
                            cursor="pointer"
                            onClick={() => setDraftStores([...storeNames])}
    ...
    <Box w="100%">
      <HStack justify="center" align="center" gap={2} mb={2} flexWrap="wrap">
        <HStack gap={1} align="flex-end">
          <Text fontSize="sm" fontWeight="semibold">{appliedStartStr}</Text>
          <Text color="var(--text-muted)" lineHeight="1">〜</Text>
          <Text fontSize="sm" fontWeight="semibold">{appliedEndStr}</Text>
        </HStack>
